...
export default async function Home() {
  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-6 bg-neutral-950 text-neutral-100">
      <h1 className="text-3xl font-semibold tracking-tight">로봇 플릿 관제</h1>
